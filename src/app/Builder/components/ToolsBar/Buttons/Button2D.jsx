...
export default function Button2D({ handleViewState }) {
	...
	return (
		<>
			...
			>
				<Grid container spacing={0.4} style={{ width: "280px" }}>
					<Grid
						item
						xs={7}
						className="cursor"
						onClick={handleViewModule(1)}
					>
						<div
					...
					<Grid
						...
						xs={7}
						className="cursor"
						onClick={handleViewModule(2)}
					>
						<div className="module">NIVEL 2</div>
					</Grid>
					<Grid
						item
						xs={7}
						className="cursor disabled"
						onClick={handleViewModule(3)}
					>
						<div className="module">NIVEL 3</div>
					</Grid>
					...
					>
						<div className="module">MÓDULO AULA</div>
					</Grid>
					...
					<Grid
						...
						style={{ marginLeft: "2.5rem" }}
					>
						<div className="module">CAFETERÍA</div>
					</Grid>
					...
					<Grid
						...
						style={{ marginLeft: "2.5rem" }}
					>
						<div className="module">BIBLIOTECA</div>
					</Grid>
					...
					<Grid
						...
						style={{ marginLeft: "2.5rem" }}
					>
						<div className="module">AUDITÓRIO</div>
					</Grid>
					{/* </Grid> */}
				</Grid>
			</Popover>
