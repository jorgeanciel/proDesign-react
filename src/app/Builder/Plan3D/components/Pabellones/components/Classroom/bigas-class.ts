...
export class Bigas {
	...
	constructor(classroom: any) {
		...
		this.material = new MeshStandardMaterial({
			color: new Color(0x404040).convertSRGBToLinear(),
		});
	...
	setBigas(classroom: any) {
		...
		this.data = [
			// HORIZONTALES
			{
				id: 0,
				position: [
					config.pos.horizontal.x,
					config.pos.horizontal.y,
					this.offset,
				],
			...
			// VERTICALES
			{
				...
				position: [
					this.offset,
					config.pos.vertical.y,
					config.pos.vertical.z,
				],
